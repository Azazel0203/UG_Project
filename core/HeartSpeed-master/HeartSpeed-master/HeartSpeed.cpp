...
*  @return void
*/
void HeartSpeed::begin() {
  ESP32TimerInterrupt::timerConfig timerConfig;
  timerConfig.timerNumber = 0;  // Choose the timer (0-3)
  timerConfig.timerCount = 5000;  // Timer count value in microseconds (5 milliseconds in this case)
  timerConfig.timerCallback = recv;
  timerConfig.timerParam = this;

  ESP32TimerInterrupt timer(timerConfig);
